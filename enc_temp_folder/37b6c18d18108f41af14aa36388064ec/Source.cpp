...
int main()
{
	...
	waterfill(friendlyboard, friendlytarget, enemyboard);
	print(friendlyboard, enemyboard);
	playerShips(friendlyboard, enemyboard);
	enemyShips(friendlyboard, enemyboard);
...
void print (char friendlyboard[][10], char friendlytarget[][10])
{
	...
	for (int flood2 = 0; flood2 < 10; flood2++)
	{
		for (int flood1 = 0; flood1 < 10; flood1++)
		{
			cout << " " << friendlyboard[flood1][flood2];
		}
		if (flood2 < 9)
		{
